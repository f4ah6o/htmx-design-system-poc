			...
			<div class="max-w-6xl mx-auto px-4 py-12">
				<header class="text-center mb-16">
					...
					<p class="text-xl text-gray-600 max-w-2xl mx-auto">
						Server-rendered design system playground with Hono, Tailwind CSS,
						Alpine.js, and htmx
					</p>
				</header>
				...
				<div class="grid md:grid-cols-2 gap-6 mb-12">
					<a
						href="/catalog"
						class="block p-8 bg-white rounded-xl shadow-sm hover:shadow-md transition border border-gray-100"
					>
				...
				<div class="grid md:grid-cols-3 gap-6">
					<a
						href="/atoms"
						class="block p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg hover:shadow-md transition"
					>
					...
					<a
						href="/molecules"
						class="block p-6 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg hover:shadow-md transition"
					>
					...
					<a
						href="/organisms"
						class="block p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-lg hover:shadow-md transition"
					>
